...
create table bebida(
nombreB			varchar(30) primary key unique,
tamaño			varchar(20),
...
totalPago		double,
nombreB			varchar(30),
foreign key (nombreB) references bebida(nombreB)
);
...
-- bebida
insert into bebida values("capuccino", "chico", "entera", "morena", "leche, cafe, azúcar", "calentar agua, mezclar el agua, cafe y azúcar al gusto");
-- cliente
insert into cliente values("FIR230943", "Isaac", "Neftali", "Burciaga", "Chacón", '2022-11-15', 10, "café", 1000, "capuccino");
-- proveedorAprobado
...
insert into empleado values("EMP32425", "Kevin", "Zaid", "Landeros", "Cruz", 8712334567, "producción", 40, "capuccino");
-- gerente
...
-- franquicia
insert into franquicia values("GDT45663", "PFWE25233", "EMP32425", "FIR230943", "capuccino");